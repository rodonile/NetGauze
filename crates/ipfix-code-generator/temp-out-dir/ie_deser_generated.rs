...
impl<'a> netgauze_parse_utils::ReadablePduWithOneInput<'a, u16, LocatedtcpControlBitsParsingError<'a>> for netgauze_iana::tcp::TCPHeaderFlags {
    #[inline]
    fn from_wire(buf: netgauze_parse_utils::Span<'a>, length: u16) -> nom::IResult<netgauze_parse_utils::Span<'a>, Self, LocatedtcpControlBitsParsingError<'a>> {
        ...
        Ok((buf, netgauze_iana::tcp::TCPHeaderFlags::from(value)))
    }
}
