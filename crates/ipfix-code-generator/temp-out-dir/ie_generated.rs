...
pub enum IE {
    ...
    /// 7, Res               Reserved
    /// 8 to 11              Reserved
    /// 12, MOB     135      IPv6 mobility [RFC3775](<https://datatracker.ietf.org/doc/rfc3775>)
    ...
    /// flow and any attached reasons.The layout of the encoding is as follows:
    /// 
    /// ```text
    ...
    /// application assignments.Values for this field are listed in the Classification
    ...
    /// corresponding bit is 0.Options are mapped to bits according to their option
    ...
    /// realm in perspective.Values are listed in the natOriginatingAddressRealm registry. See
    ///
    ...
    /// |        |          | [RFC5103](<https://datatracker.ietf.org/doc/rfc5103>) are interpreted as external         |
    ...
    /// Process.Most of these methods have parameters.  Further Information
    /// Elements are needed to fully specify packet selection with these
    /// methods and all their parameters.The methods listed below are defined inFurther method identifiers may be added to the list below.  It
    /// might be necessary to define new Information Elements to specify
    /// their parameters.The following packet selection methods identifiers are defined
    /// here:There is a broad variety of possible parameters that could be used
    ...
    /// defined in section 3.1 of the IPFIX Information ModelThese types are registered in the IANA IPFIX Information Element
    ...
    /// section 3.2 of the IPFIX Information ModelThese semantics are registered in the IANA IPFIX Information
    ...
    /// Information ModelThese types are registered in the
    ///
    /// Reference: [RFC5610](https://datatracker.ietf.org/doc/html/rfc5610)
    ...
    /// range is defined in some other way.Additional information on defined TCP port numbers can be found at
    ///
    portRangeStart,
    ...
    /// link frame.Data link types are defined in the dataLinkFrameType registry. SeeFurther values may be assigned by IANA.  Note that the assigned
    /// values are bits so that multiple observations can be OR'd
    /// together.The data link layer is defined in [ISO/IEC.7498-1:1994].
    ///
    /// Reference: [RFC7133](https://datatracker.ietf.org/doc/html/rfc7133)
    dataLinkFrameType,
    ...
    /// counters or statistics.If the MIB value was sampled by SNMP prior to the IPFIX Metering
    ...
    /// with the OID using IPFIX Structured Data [RFC6313](<https://datatracker.ietf.org/doc/rfc6313>).  Similarly, if
    ...
    /// Structured Data.Values are listed in the mibCaptureTimeSemantics registry. See
    ///
    /// Reference: [RFC8038](https://datatracker.ietf.org/doc/html/rfc8038)
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowStartSeconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowEndSeconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowStartMilliseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowEndMilliseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowStartMicroseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowEndMicroseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowStartNanoseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct flowEndNanoseconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct systemInitTimeMilliseconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct collectionTimeMilliseconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct maxExportSeconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct maxFlowEndSeconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct minExportSeconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct minFlowStartSeconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct maxFlowEndMicroseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct maxFlowEndMilliseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct maxFlowEndNanoseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct minFlowStartMicroseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct minFlowStartMilliseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct minFlowStartNanoseconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct observationTimeSeconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct observationTimeMilliseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct observationTimeMicroseconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct observationTimeNanoseconds(pub chrono::DateTime<chrono::Utc>);
...
#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct monitoringIntervalStartMilliSeconds(pub chrono::DateTime<chrono::Utc>);

#[allow(non_camel_case_types)]
#[derive(Copy, Eq, Clone, PartialEq, Debug, serde::Serialize, serde::Deserialize)]
pub struct monitoringIntervalEndMilliSeconds(pub chrono::DateTime<chrono::Utc>);
