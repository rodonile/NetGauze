...
fn main() {
    ...
    //     buf,
    //     vec![
    //         0, 10, 0, 40, 100, 3, 50, 192, 0, 0, 14, 228, 0, 0, 0, 0, 0, 2, 0,
    // 24, 1, 51, 0, 4, 0,         8, 0, 4, 0, 12, 0, 4, 0, 1, 0, 4, 0, 2, 0, 4,
    //     ]
    // );
        ...
        vec![Set::Data {
            ...
            records: vec![DataRecord::new(
                ...
                vec![
                    ...
                    ie::Field::NetGauze(netgauze::Field::isRenormalized(netgauze::isRenormalized(
                        true,
                    ))),
    ...
    //     buf,
    //     vec![
    //         0, 10, 0, 36, 100, 3, 50, 193, 0, 0, 14, 228, 0, 0, 0, 0, 1, 51, 0,
    // 20, 70, 1, 115, 1,         50, 0, 71, 1, 0, 0, 5, 32, 0, 0, 0, 9
    //     ]
    // );
    // Deserialize the message from binary format
    let (_, msg_back) = IpfixPacket::from_wire(Span::new(&buf), Rc::clone(&templates_map)).unwrap();
